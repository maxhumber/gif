...
df['episode'] = df['episode'].apply(lambda x: float(f'{x.split("E")[0][1:]}.{x.split("E")[1]}'))
...
gif.save(frames, 'gallery/matplotlib/seinfeld/seinfeld.gif', duration=100)
